...
/**
  ...
  * 100
  * tableTest
  * hdfs://cdh-master-dc-1:8020/tmp/dc-streaming/checkpoint/MinuteAvgValue_foreach/
  *
  */
object MinuteAvgValue_foreach {
...
//    ruleServiceApi = "http://114.115.238.197:8088/rulemgr/v1/ruleInstanceWithBindByCode?code=clean_normal_by_minute"
...
//    hbaseTableName = "tableTest"
    ...
    val checkpointLocation =
      if (args.length > 9) args(9) else "/tmp/temporary-MinuteAvgValue_foreach-" + UUID.randomUUID.toString
